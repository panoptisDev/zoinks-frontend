...
const snacksMintText = ['BtcSnacks Buy Back', 'BtcSnacks Buy']

export default function BtcSnacksMint({ history }: RouteComponentProps) {
  ...
  const parsedAmounts = showWrap
    ...
    : {
        [Field.INPUT]: new TokenAmount(tokens.wbtc, '1'),
  ...
  const { btcsnacksBuy, btcsnacksRedeem } = useBtcSnacksMint()
  const handleSwap = async () => {
    try {
      if (textIndex === 0) await btcsnacksRedeem(formattedAmounts[Field.INPUT])
      else await btcsnacksBuy(formattedAmounts[Field.OUTPUT])
    } catch (e) {
      console.log(e)
    }
  }
            ...
            <StyledInputCurrencyWrapper mt={isChartExpanded ? '24px' : '0'}>
              <AppBody>
                <CurrencyInputHeader
                  ...
                  subtitle={t('Buy BtcSnacks in an instant')}
