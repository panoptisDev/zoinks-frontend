...
const snacksMintText = ['EthSnacks Buy Back', 'EthSnacks Buy']
...
export default function EthSnacksMint({ history }: RouteComponentProps) {
  ...
  const handleSwap = async () => {
    try {
      if (textIndex === 0) await ethsnacksRedeem(formattedAmounts[Field.INPUT])
      else await ethsnacksBuy(formattedAmounts[Field.OUTPUT])
    } catch (e) {
      console.log(e)
    }
  }
            ...
            <StyledInputCurrencyWrapper mt={isChartExpanded ? '24px' : '0'}>
              <AppBody>
                <CurrencyInputHeader
                  ...
                  subtitle={t('Buy EthSnacks in an instant')}
