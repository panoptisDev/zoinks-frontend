...
import { Box, Flex, InjectedModalProps, Modal, Button, Spinner } from '@zoinks-swap/uikit'
...
const VoteDetailsModal: React.FC<VoteDetailsModalProps> = ({ block, onDismiss }) => {
  ...
  return (
    <Modal title={t('Voting Power')} onDismiss={handleDismiss} headerBackground={theme.colors.backgroundAlt}>
