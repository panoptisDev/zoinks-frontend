...
import { Box, Flex, lightColors, Spinner, Text, Timeline } from '@zoinks-swap/uikit'
...
const PancakeSquadHeader: React.FC<PancakeSquadHeaderType> = ({
  ...
  return (
    ...
    >
      ...
      <Text color={lightColors.warning} textAlign="center" bold>
        {t('Mint Cost: %minCost% Zoinks each', {
      ...
      <Text color={lightColors.invertedContrast} textAlign="center">
        {t('ZoinksSwap’s first official generative NFT collection.')}
      </Text>
