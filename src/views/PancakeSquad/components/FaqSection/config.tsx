...
import { Text } from '@zoinks-swap/uikit'
...
const config = ({ t }: FAQsType) => [
  ...
  },
  {
    ...
    description: [
      t(
        'Wait for the reveal! After all 10,000 members of the Zoinks Squad have been minted, their images will remain hidden for a few days. Just be patient :)',
      ),
    ],
  },
  {
    ...
    description: [
      ...
      t(
        'Users holding Gen 0 Zoinks Bunny NFTs at the snapshot may also purchase one additional Zoinks Squad NFT in the presale for each Zoinks Bunny they hold.',
      ),
      t(
