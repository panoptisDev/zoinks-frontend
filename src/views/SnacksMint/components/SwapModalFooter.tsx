...
import { Trade, TradeType } from '@zoinks-swap/sdk'
import { Button, Text, AutoRenewIcon } from '@zoinks-swap/uikit'
            ...
            <QuestionHelper
              text={
                <>
                  ...
                  <Text>- {t('%amount% towards Zoinks buyback and burn', { amount: '0.05%' })}</Text>
                </>
              }
              ml="4px"
            />
