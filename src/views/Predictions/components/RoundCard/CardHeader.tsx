...
import { Flex, Text } from '@zoinks-swap/uikit'
...
export const getBorderBackground = (theme: DefaultTheme, status: Status) => {
  ...
  switch (status) {
    case 'calculating':
      return `linear-gradient(transparent ${gradientStopPoint}, ${theme.colors.cardBorder} ${gradientStopPoint}), ${theme.colors.backgroundAlt}`
    case 'canceled':
