...
export const getEarningsText = (
  ...
  if (numFarmsToCollect > 0 && hasCakePoolToCollect) {
    if (numFarmsToCollect > 1) {
      earningsText = t('%earningsBusd% to collect from %count% farms and Zoinks pool', data)
    } else {
      earningsText = t('%earningsBusd% to collect from %count% farm and Zoinks pool', data)
    }
    ...
    earningsText = t('%earningsBusd% to collect from Zoinks pool', data)
  }
