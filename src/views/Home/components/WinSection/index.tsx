...
import { Flex, Text, TicketFillIcon, PredictionsIcon } from '@zoinks-swap/uikit'
...
const bottomLeftImage = {
  ...
  attributes: [
    { src: 'bottom-left', alt: 'Zoinks card' },
    { src: 'green', alt: 'Green Zoinks card with up arrow' },
    { src: 'red', alt: 'Red Cake card with down arrow' },
    { src: 'top-right', alt: 'Zoinks card' },
  ],
}
