...
import { Flex, Text, Skeleton, Button, ArrowForwardIcon } from '@zoinks-swap/uikit'
...
const LotteryCardContent = () => {
  ...
  const cakePrizesText = t('%cakePrizeInUsd% in Zoinks prizes this round', { cakePrizeInUsd: cakePriceBusdAsString })
    ...
    <>
      <Flex flexDirection="column" mt="48px">
        ...
        <Text color="white" mb="40px">
          {t('Buy tickets with Zoinks, win Zoinks if your numbers match')}
        </Text>
      </Flex>
