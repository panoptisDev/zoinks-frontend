...
import { Text, useMatchBreakpoints, TokenPairImage as UITokenPairImage } from '@zoinks-swap/uikit'
...
const NameCell: React.FC<NameCellProps> = ({ pool }) => {
  ...
  if (vaultKey) {
    ...
    title = t('Manual Zoinks')
    subtitle = `${t('Earn')} Zoinks ${t('Stake').toLocaleLowerCase()} Zoinks`
  }
