...
import { useSnacksAmountUSD, useEthSnacksAmountUSD, useBtcSnacksAmountUSD } from 'hooks/useBUSDPrice'
...
const SnacksCardActions: React.FC<CardActionsProps> = ({ pool, stakedBalance }) => {
  ...
  const earningSnacksBalance = getBalanceNumber(earnings, earningToken.decimals)
  const earningSnacksUSDBalance = useSnacksAmountUSD(earnings)
...
export default SnacksCardActions
