...
export const DEFAULT_META: PageMeta = {
  title: 'PancakeSwap',
  description:
    'The most popular AMM on BSC by user count! Earn CAKE through yield farming or win it in the Lottery, then stake it in Zoinks Pools to earn more tokens! Initial Farm Offerings (new token launch model pioneered by PancakeSwap), NFTs, and more, on a platform you can trust.',
...
export const getCustomMeta = (path: string, t: ContextApi['t']): PageMeta => {
  ...
  switch (basePath) {
    ...
    case '/pancake-squad':
      return {
        title: `${t('Zoinks Squad')} | ${t('PancakeSwap')}`,
      }
    default:
      return null
  }
